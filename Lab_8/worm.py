...
class Snake:
    def __init__(self, pos, walls):
        ...
        self.head_img = pygame.image.load('Lab_8/img/head.png')
        self.body_img = pygame.image.load('Lab_8/img/body.png')
        self.tail_img = pygame.image.load('Lab_8/img/tail.png')
        self.turn_img = pygame.image.load('Lab_8/img/turn.png')  # Новый изгиб тела
