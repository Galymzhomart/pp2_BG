...
pencil = pygame.image.load('Lab_8/img/pencil.png')
...
bucket = pygame.image.load('Lab_8/img/bucket.png')
bucket = pygame.transform.scale(bucket, (75, 75))

eraser = pygame.image.load('Lab_8/img/eraser.png')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('Lab_8/img/figures.png')
figures = pygame.transform.scale(figures, (75, 75))

pallete = pygame.image.load('Lab_8/img/palette.png')
